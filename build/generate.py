...
CONFIG = {
    "titulo": "Catálogo de Plantas Químicas Industriales — Chile",  # <title> + h1 del index
    "kicker_index": "Inteligencia comercial · Plantas químicas",
    "sub_index": ("Plantas chilenas que fabrican compuestos químicos de proceso continuo "
                  "(cobre/azufre, agroquímicos, químicos industriales, minería, celulosa). "
                  "Cada ficha trae: quién es, qué hace, proyectos/clientes, tomadores de "
                  "decisión técnicos y el ángulo CONECTA — todo con fuente verificable."),
    "kicker_ficha": "Expediente de prospecto · Química industrial",
    "ficha_sufijo": "· Plantas Químicas Industriales",  # sufijo del <title> de cada ficha
    "empresas_label": "Plantas",
    "footer_index": "CONECTA Ingeniería · Catálogo de plantas químicas · agosto 2026",
    "footer_ficha": "CONECTA Ingeniería · Catálogo de plantas químicas · agosto 2026 · Cada dato cita su fuente verificable",
    "leyenda": [  # (clase-dot, texto)
        ("g", "CLIENTE FINAL — planta de proceso que especifica/compra DCS + SCADA + instrumentación"),
    ],
}
